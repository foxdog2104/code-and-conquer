...
@onready var is_level_1_finished = false
@onready var is_level_2_finished = false

@onready var level_status : Array = [is_level_1_finished,is_level_2_finished] #Whenever we add more levels we will adapt this script add more boleans to each level status
